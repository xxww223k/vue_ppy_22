        ...
        <a-spin :spinning="loading">
            <div :class="['header-bar', size]">
                ...
                <div class="actions">
                    ...
                    <a-tooltip title="全屏">
                        <a-icon @click="toggleScreen" class="action"
                            :type="fullScreen ? 'fullscreen-exit' : 'fullscreen'" />
                    </a-tooltip>
                </div>
            </div>
            <a-table v-bind="{...$props, columns: visibleColumns, title: undefined, loading: false}" :size="sSize"
                @expandedRowsChange="onExpandedRowsChange" @change="onChange" @expand="onExpand">
